...
<div class="ins1">
  <div class="ins">
    <h2>Update professor achievement details</h2>
    <div class="line">
    ...
    <div class="form1">
    <form method="post" action="modal-update-prof.php">
  ...
  $id=$_POST["idscr"];
  $file1=fopen("insert_achievement_prof.txt","r") or die("cannot open");
  $i=strval($id);
  while(!feof($file1)){
    $line1=fgets($file1);
...
?>
    ...
    <form method="post"  action="update_prof.php">
      <lable style="font-size: 20px;">Professor identification number</lable>
      <input type="text" class="form-control" name="id" size="40" value="<?php echo "$ext1";?>"/><br>
      <lable style="font-size: 20px;">Professor name</lable>
      <input type="text" class="form-control" name="name" value="<?php echo "$ext2";?>" /><br>
      <lable style="font-size: 20px;">Professor department</lable>
      <input type="text" class="form-control" name="deptno" value="<?php echo "$ext3";?>"/><br>
      <lable style="font-size: 20px;">Recognitions received </lable>
      <input type="text" class="form-control" name="reg" value="<?php echo "$ext4";?>"/><br>
      <lable style="font-size: 20px;">Professor achievement</lable>
      <input type="text" class="form-control" name="ach" value="<?php echo "$ext5";?>"/><br><br>
